export const uncommonVocabularies: Data[] = [
  ...
  },
  {
    ...
    sentences: [
      `The gourmet restaurant is known for its exquisite cuisine and elegant ambiance.`,
      `The jewelry shop displays exquisite pieces adorned with precious gems.`,
      `The artist's brushstrokes brought out the exquisite details of the still-life painting.`,
      `The garden featured an array of exquisite flowers in vibrant colors.`,
      `The vintage car was restored to its original exquisite condition.`,
    ],
  },
  {
    word: 'picturesque',
    ...
    sentences: [
      `The small village nestled in the mountains was truly picturesque.`,
      `The artist captured the picturesque landscape with vibrant colors.`,
      `The old cottage by the lake had a picturesque charm that attracted tourists.`,
      `The sunsets over the ocean were always breathtakingly picturesque.`,
      `The garden was a picturesque haven of colorful flowers and serene paths.`,
    ],
  },
  {
    word: 'unravel',
    description: [
      `If a piece of knitted or woven cloth, a knot, or a mass of thread ___s, it separates into a single thread, and if you ___ it, you separate it into a single thread`,
      `to solve a crime or explain a mystery`,
    ],
    sentences: [
      `The detective worked tirelessly to unravel the mystery behind the missing artifact.`,
      `As the story progressed, the author began to unravel the complex plot.`,
      `The research project aimed to unravel the underlying causes of the phenomenon.`,
      `Over time, the truth started to unravel as witnesses came forward.`,
      `The scientist's groundbreaking discovery helped unravel a longstanding scientific question.`,
    ],
  },
  {
    word: 'implications',
    ...
    sentences: [
      `The discovery of water on Mars has profound implications for the possibility of life.`,
      `The economic implications of the policy change are still being analyzed.`,
      `The implications of the new technology on job markets are a topic of concern.`,
      `The study's findings have far-reaching implications for climate change research.`,
