export const vocabularies: Data[] = [
  ...
  },
  {
    ...
    sentences: [
      ...
      " The company's expenditure on marketing increased significantly last year.",
    ],
  },
  {
    word: 'fruitful (c1)',
  ...
  {
    word: 'mislead (c1)',
    description: [`to cause someone to believe something that is not true`],
    sentences: [
  ...
  {
    word: 'adequate',
    description: [`(b2) enough or satisfactory for a particular purpose`],
    sentences: [
  ...
  {
    word: 'adopt',
    description: [`(b2) to accept or start to use something new`],
    sentences: [
  ...
  {
    word: 'abundant',
    description: [`more than enough`, `more than enough; a lot of`],
    sentences: [
  ...
  {
    word: 'accidentally',
    description: [`by chance or by mistake`],
    sentences: [
  ...
  {
    word: 'advisable',
    description: [`If something is ___, it will avoid problems if you do it`],
    sentences: [
  ...
  {
    word: 'ameliorate',
    description: [`to make a bad or unpleasant situation better`],
    sentences: [
  ...
  {
    word: 'anxious',
    description: [`worried and nervous`, `eager to do something`],
    sentences: [
  ...
  {
    word: 'carriage',
    description: [`a vehicle with four wheels pulled by a horse or horses`],
    sentences: [
  ...
  {
    word: 'comprehend',
    description: [`to understand something completely`],
    sentences: [
  ...
  {
    word: 'culinary',
    description: [`connected with cooking or kitchens`],
    sentences: [
  ...
  {
    word: 'dialogue',
    description: [`conversation that is written for a book, play, or film`],
    sentences: [
  ...
  {
    word: 'disgusting',
    description: [`extremely unpleasant or unacceptable`],
    sentences: [
  ...
  {
    word: 'disparate',
    description: [`different in every way`, `different in every way`],
    sentences: [
  ...
  {
    word: 'elegant',
    description: [`graceful and attractive in appearance or behaviour`],
    sentences: [
  ...
  {
    word: 'engaged',
    description: [`having formally agreed to marry`, `involved in something`],
    sentences: [
  ...
  {
    word: 'evident',
    description: [`easily seen or understood`],
    sentences: [
  ...
  {
    word: 'extinct',
    description: [`not now existing`, `no longer existing`],
    sentences: [
  ...
  {
    word: 'facilitate',
    description: [`to make something possible or easier`],
    sentences: [
  ...
  {
    word: 'fascinating',
    description: [`extremely interesting`],
    sentences: [
  ...
  {
    word: 'fraud',
    description: [`the crime of getting money by deceiving people`],
    sentences: [
  ...
  {
    word: 'frightening',
    description: [`making you feel fear`],
    sentences: [
  ...
  {
    word: 'hamper',
    description: [`o prevent someone doing something easily`],
    sentences: [
  ...
  {
    word: 'handy',
    description: [`useful or convenient`],
    sentences: [
  ...
  {
    word: 'hitchhike',
    description: [`to travel by getting free rides in someone else's vehicle`],
    sentences: [
  ...
  {
    word: 'horrible',
    description: [`very unpleasant or bad`, `very shocking and frightening`],
    sentences: [
  ...
  {
    word: 'imperative',
    description: [`extremely important or urgent`],
    sentences: [
  ...
  {
    word: 'inaugural',
    description: [`An ___ event is the first in a series of planned events`],
    sentences: [
  ...
  {
    word: 'increasingly',
    description: [`more and more`, `more often or to a greater degree`],
    sentences: [
  ...
  {
    word: 'irritate',
    description: [`to make someone angry or annoyed`, `to annoy or make angry`],
    sentences: [
  ...
  {
    word: 'lifelong',
    description: [`lasting for the whole of a person's life`],
    sentences: [
  ...
  {
    word: 'likewise',
    description: [`in the same way`, `in the same way or manner; similarly`],
    sentences: [
  ...
  {
    word: 'occasionally',
    description: [`sometimes but not often`, `not often or regularly`],
    sentences: [
  ...
  {
    word: 'openly',
    description: [`without hiding any of your thoughts or feelings`],
    sentences: [
  ...
  {
    word: 'pastime',
    description: [`an activity that is done for enjoyment`],
    sentences: [
  ...
  {
    word: 'promptly',
    description: [`quickly, without delay, or at the arranged time`],
    sentences: [
  ...
  {
    word: 'proximity',
    description: [`the state of being near in space or time`],
    sentences: [
  ...
  {
    word: 'rectify',
    description: [`to correct something or make something right`],
    sentences: [
  ...
  {
    word: 'relinquish',
    description: [`to give up something such as a responsibility or claim`],
    sentences: [
  ...
  {
    word: 'reluctant',
    description: [`not willing to do something and therefore slow to do it`],
    sentences: [
  ...
  {
    word: 'reportedly',
    description: [`according to what many people say`],
    sentences: [
  ...
  {
    word: 'satisfactory',
    description: [`good or good enough for a particular need or purpose`],
    sentences: [
  ...
  {
    word: 'screening',
    description: [`a showing of a film`],
    sentences: [
  ...
  {
    word: 'sewage',
    description: [`waste matter such as water or human urine or solid waste`],
    sentences: [
  ...
  {
    word: 'situated',
    description: [`in a particular position`],
    sentences: [
  ...
  {
    word: 'ski',
    description: [`to move over snow on skis`],
    sentences: [
  ...
  {
    word: 'spectacular',
    description: [`very exciting to look at, especially great`],
    sentences: [
  ...
  {
    word: 'subsequent',
    description: [`happening after something else`],
    sentences: [
  ...
  },
  {
    ...
    description: [
      ...
      `(n) a person or group of people who are higher in rank or social position than others`,
    ],
    sentences: [
  ...
  {
    word: 'surplus',
    description: [`(an amount that is) more than is needed`],
    sentences: [
  ...
  },
  {
    ...
    description: [
      ...
      `(n) a drop of salty liquid that flows from the eye, as a result of strong emotion, especially unhappiness, or pain`,
    ],
    sentences: [
  ...
  {
    word: 'termination',
    description: [`the act of ending something or the end of something`],
    sentences: [
  ...
  },
  {
    ...
    description: [
      ...
      `because of this; as a result of this action`,
    ],
    sentences: [
  ...
  },
  {
    ...
    description: [
      ...
      `the need or desire to drink something, esp. water`,
    ],
    sentences: [
  ...
  },
  {
    word: 'thoughtful',
    description: [
      `carefully considering things, tending to think seriously about things`,
  ...
  },
  {
    ...
    description: [
      ...
      `given or made available at a suitable moment, esp. now`,
    ],
    sentences: [
  ...
  },
  {
    ...
    description: [
      ...
      `(n) a journey in which you go somewhere, usually for a short time, and come back again`,
    ],
    sentences: [
  ...
  },
  {
    ...
    description: [`the quality or fact of not being easy to notice`],
    sentences: [
  ...
  {
    word: 'untidy',
    description: [`not neat or well-arranged`],
    sentences: [
  ...
  },
  {
    word: 'unversed',
    description: [
      `not knowing a lot about a particular thing or having experience of it`,
    ],
    sentences: [
  ...
  {
    word: 'various',
    description: [`many different`, `several and different`],
    sentences: [
  ...
  {
    word: 'weird',
    description: [`very strange and unusual, unexpected, or not natural`],
    sentences: [
  ...
  {
    word: 'while',
    description: [`during the time that, or at the same time as`],
    sentences: [
  ...
  {
    word: 'wordy',
    description: [`containing too many word`],
    sentences: [
  ...
  {
    word: 'worsen',
    description: [`to become worse or to make something become worse`],
    sentences: [
